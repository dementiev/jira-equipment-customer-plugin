...
public class InvNumberCF extends CalculatedCFType implements SortableCustomField {
    Logger log = Logger.getLogger(InvNumberCF.class);
    ...
    public Object getValueFromIssue(CustomField field, Issue issue) {
        String result = "";
            ...
            if (propertySet != null) {
                String inv = propertySet.getString("invNumber");
                if (TextUtils.stringSet(inv)) {
                    result = inv;
                }
        }
        return result;
